...
describe User do
	...
	describe "password encryption" do
		...
		before(:each) do
			@user = User.create!(@attr) #creation will be saved in database
		end
		...
		it "should set the encrypted password" do
			...
			#the code above is equal to encrypted_passwork.blank? == not true
		end
	...
	describe "authenticate method" do
		...
		it "should return nil for an email address with no user" do
			nonexistent_user = User.autheticate("bar@foobar.com", @attr[:password])
